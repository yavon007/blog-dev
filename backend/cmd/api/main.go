...
import (
	...
	"github.com/yourblog/backend/internal/app"
	"github.com/yourblog/backend/internal/config"
	"github.com/yourblog/backend/internal/modules/auth/core"
	authrepo "github.com/yourblog/backend/internal/modules/auth/repository"
	authhttp "github.com/yourblog/backend/internal/modules/auth/transport/http"
	commentscore "github.com/yourblog/backend/internal/modules/comments/core"
	commentsrepo "github.com/yourblog/backend/internal/modules/comments/repository"
	commentshttp "github.com/yourblog/backend/internal/modules/comments/transport/http"
	postscore "github.com/yourblog/backend/internal/modules/posts/core"
	postsrepo "github.com/yourblog/backend/internal/modules/posts/repository"
	postshttp "github.com/yourblog/backend/internal/modules/posts/transport/http"
	taxonomycore "github.com/yourblog/backend/internal/modules/taxonomy/core"
	taxonomyrepo "github.com/yourblog/backend/internal/modules/taxonomy/repository"
	...
	"github.com/yourblog/backend/internal/platform/database"
	"github.com/yourblog/backend/internal/platform/logger"
	"go.uber.org/zap"
)
